...
test6_2 = {
    ...
    "title": "[Test06-1] Bucket의 S3 퍼블릭 엑세스 설정 여부",
...
test7 = {
    ...
    "Success": {
        "level": "Success",
        "msg": [
            {"text": "알람이 켜져있습니다. 비용과 루트 계정 알람인지 확인해 주세요.", "link": ""}
        ]
    },
...
test8 = {
    ...
    "Warning": {
        "level": "Warning",
        "msg": [
            {"text": "링크", "link": "https://us-east-1.console.aws.amazon.com/ec2globalview/home"},
            {"text": "를 통해 현황을 확인하고, 사용하지 않는 항목을 삭제해주세요.", "link": ""}
        ]
    },
...
test9 = {
    ...
    "Subscript": {
        "level": "Warning",
        "msg": [
                {"text": "Trusted Advisor를 사용하기 위해서는 AWS 비즈니스 Support 또는 엔터프라이즈 Support 플랜에 가입하여야 합니다.", "link":""}, 
            ]
    },
